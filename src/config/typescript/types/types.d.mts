import type { AstNode, AstNodeLeaf, AstNodeParent } from "@ranki/package-api-v2";
import type { NodeArgsBaseV2 } from "@ranki/plugin-parser-base-v2";
export type NodeArgRichTextV2WordDecoration = NodeArgRichTextV2SentenceEnd & NodeArgRichTextV2Abbreviation & NodeArgRichTextV2B & NodeArgRichTextV2Em & NodeArgRichTextV2I & NodeArgRichTextV2U & NodeArgRichTextV2LineModifiers;
...
type NodeArgRichTextV2LineModifiers = NodeArgRichTextV2Alignment & NodeArgRichTextV2SmallText & NodeArgRichTextV2Heading;
...
export type NodeArgsRichTextV2 = Partial<NodeArgsBaseV2> & Partial<NodeArgRichTextV2WordDecoration>;
type Single = string;
...
export type ParseNodeRichTextV2 = ParseNodeRichTextV2Leaf | ParseNodeRichTextV2Parent;
...
export type ParseNodeRichTextV2LeafReduced = Omit<ParseNodeRichTextV2Leaf, "shape" | "parser" | "parent"> & {
    shape: Omit<ParseNodeRichTextV2Leaf["shape"], "depth">;
};
export type ParseNodeRichTextV2ParentReduced = Omit<ParseNodeRichTextV2Parent, "shape" | "parser" | "parent" | "subtree" | "children"> & {
