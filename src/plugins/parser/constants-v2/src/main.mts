...
function tokenize(config: any): Tokens {
  ...
  {
    if (config.plugins.config.RankiParamsV2) {
  ...
  {
    if (config.plugins.config.RankiRichTextV2) {
  ...
  {
    if (config.plugins.config.RankiBaseV2) {
