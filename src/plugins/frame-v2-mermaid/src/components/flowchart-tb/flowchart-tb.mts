...
export const frameV2FlowchartTbComponent: IDqmComponent<HtmlPrimitiveAnchorComponentConfig> =
  {
    type: "component",
    meta: {
      id: {
        chain: ["frame", "v2", "charts", "mermaid", "flowchart", "tb"],
        aliases: ["flowchart_tb"],
      },
