...
// @ts-expect-error
const session: GeometryUpdateSessionWithSpanContext = null;
...
test("single session two elems", async () => {
  ...
  // const expected1: LayoutSizing = {
  //   session,
  //   type: "terminate",
  // };
  const call1 = () => children.onEmit({ target: target1, detail: detail1 });
  const call2 = () => children.onEmit({ target: target2, detail: detail2 });
...
//     type: "terminate",
//   };
//   const call1_1 = () => children.onEmit({ target: target1, detail: detail1_1 });
//   const call1_2 = () => children.onEmit({ target: target2, detail: detail1_2 });
//   const call2_1 = () => children.onEmit({ target: target1, detail: detail2_1 });
//   const call2_2 = () => children.onEmit({ target: target2, detail: detail2_2 });
