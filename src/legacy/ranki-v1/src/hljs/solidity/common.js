...
export function isNegativeLookbehindAvailable()
{
  try {
    new RegExp('(?<!.)');
    return true;
...
export var SOL_NUMBER = {
  className: 'number',
  begin: SOL_NUMBER_RE,
  relevance: 0,
};

export var SOL_ASSEMBLY_KEYWORDS = {
  keyword:
    'assembly ' +
    'let function ' +
...
export function solAposStringMode(hljs)
{
  return hljs.inherit(
...
export function solQuoteStringMode(hljs)
{
  return hljs.inherit(
...
export function baseAssembly(hljs)
{
