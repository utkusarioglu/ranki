...
export const debugComponent: IDqmComponent<ComponentType> = {
  type: "component",
  meta: {
    id: {
      chain: ["frame", "v2", "debug", "environment_info"],
      aliases: [],
    },
    description:
      "Prints information about the environment of the language instance",
    version: "0.0.0",
    examples,
  },
  customizations: {
